...
_extract_translations:
	pybabel extract -F eol_vimeo/locale/babel.cfg -o eol_vimeo/locale/django.pot --msgid-bugs-address=eol-ing@uchile.cl --copyright-holder='Oficina EOL' --project=eol-vimeo --version=1.0.0 --last-translator='Oficina EOL <eol-ing@uchile.cl>' *
	pybabel extract -F eol_vimeo/locale/babel-js.cfg -o eol_vimeo/locale/django-js.pot --msgid-bugs-address=eol-ing@uchile.cl --copyright-holder='Oficina EOL' --project=eol-vimeo --version=1.0.0 --last-translator='Oficina EOL <eol-ing@uchile.cl>' *
